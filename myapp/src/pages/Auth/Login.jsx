...
const Login = () => {
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      setError(t("auth_error_google_login"));
    } finally {
      setLoading(false);
    }
  };
      ...
      <div className={scss.loginCard}>
        <div className={scss.cardHeader}>
          <div className={scss.logo}>
            ...
            <h1 className={scss.logoText}>{t("app_title")}</h1>
          </div>
          <h2>{t("auth_login_welcome")}</h2>
          <p className={scss.cardSubtitle}>{t("auth_login_subtitle")}</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className={scss.form}>
          ...
          <div className={scss.formGroup}>
            ...
            <div className={scss.passwordHelper}>
              <Link to="/forgot-password" className={scss.forgotLink}>
          ...
          <div className={scss.divider}>
            ...
            <span className={scss.dividerText}>{t("auth_login_or")}</span>
            <span className={scss.dividerLine}></span>
          </div>
          ...
          >
            ...
            <span className={scss.googleText}>{t("auth_google_login")}</span>
          </button>
          ...
          <div className={scss.links}>
            ...
            <p className={scss.linkItem}>
              {t("auth_admin")}{" "}
              <Link to="/admin-login" className={scss.link}>
                {t("auth_admin_login")}
              </Link>
            </p>
          </div>
